...
global using FastDeliveryBE.Const;
global using FastDeliveryBE.Models;

namespace FastDeliveryBE.Repositories.Base
{
    public class BaseRepositoy<T> : IBaseRepositoy<T> where T : class
    {
        protected FastDeliveryContext _Context;
        public BaseRepositoy(FastDeliveryContext Context)
        {
            _Context = Context;
        }
